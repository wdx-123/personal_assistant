...
func InitConfig(path string) {
	...
	viper.SetDefault("task.oj_daily_stats_repair_cron", "@daily")
	viper.SetDefault("task.oj_daily_stats_repair_batch_size", 100)
	viper.SetDefault("task.oj_daily_stats_repair_window_days", 35)
	...
	_ = viper.BindEnv("task.oj_daily_stats_repair_cron", "TASK_OJ_DAILY_STATS_REPAIR_CRON")
	_ = viper.BindEnv("task.oj_daily_stats_repair_batch_size", "TASK_OJ_DAILY_STATS_REPAIR_BATCH_SIZE")
	_ = viper.BindEnv("task.oj_daily_stats_repair_window_days", "TASK_OJ_DAILY_STATS_REPAIR_WINDOW_DAYS")
	...
	_ = viper.BindEnv("messaging.oj_daily_stats_projection_topic", "MESSAGING_OJ_DAILY_STATS_PROJECTION_TOPIC")
	_ = viper.BindEnv("messaging.oj_daily_stats_projection_group", "MESSAGING_OJ_DAILY_STATS_PROJECTION_GROUP")
	_ = viper.BindEnv("messaging.oj_daily_stats_projection_consumer", "MESSAGING_OJ_DAILY_STATS_PROJECTION_CONSUMER")
