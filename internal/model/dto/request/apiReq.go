...
type ApiListReq struct {
	...
	SyncState string `form:"sync_state" binding:"omitempty,oneof=registered missing archived"` // 路由同步状态过滤
}
...
type SyncApiReq struct {
	DeleteRemoved bool `json:"delete_removed"` // 兼容旧参数，当前不再执行物理删除
}
